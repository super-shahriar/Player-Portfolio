...
class StoryModel(BaseModel):
    ...
    # Engagement
    likes: List[str] = Field(default_factory=list, description="List of user IDs who liked")
    claps: List[str] = Field(default_factory=list, description="List of user IDs who clapped")
    reactions: List[Reaction] = Field(default_factory=list)
    view_count: int = Field(default=0, ge=0)
    
    # Visibility
    is_active: bool = Field(default=True, description="Stories expire, highlights don't")
