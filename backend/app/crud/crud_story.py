...
class CRUDStory:
    ...
    async def get_story(
        self, story_id: str, increment_view: bool = False
    ) -> Optional[StoryDocument]:
        """
        Get a story by ID.
    ...
    async def get_active_stories(
        self, athlete_id: str, include_expired: bool = False
    ) -> List[StoryDocument]:
        """
        ...
        """
        query = {"athlete_id": athlete_id, "is_highlight": False}
    ...
    async def get_highlights(self, athlete_id: str) -> List[StoryDocument]:
        ...
        """
        query = {"athlete_id": athlete_id, "is_highlight": True}
    ...
    async def add_reaction(
        self, story_id: str, reaction_data: ReactionDocument
    ) -> bool:
        """
    ...
    async def cleanup_expired_stories(self) -> int:
        ...
        result = await self.collection.delete_many(
            {"is_highlight": False, "expires_at": {"$lt": datetime.now(timezone.utc)}}
        )
